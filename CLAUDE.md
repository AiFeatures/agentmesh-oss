# agentmesh-oss — Claude Code Context

## Overview

- **Repository**: AiFeatures/agentmesh-oss
- **Enterprise**: iAiFy
- **Language**: TypeScript
- **Description**: Open-source coordination hub for autonomous AI agents. Register, claim files, handoff work, escalate blockers. Hub, not orchestrator.
